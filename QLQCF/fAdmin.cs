...
namespace QLQCFTest
{
    public partial class fAdmin : Form
    {
        ...
        private void btnAddFood_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        if (CategoryDAO.Instance.GetCateWithID(categoryID) != null)
                        {
                        ...
                        else { MessageBox.Show("ID của category không tìm thấy"); }
                    }
                }
        ...
        private void btnEditCategory_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int active = Convert.ToInt32(txbCategoryActive.Text);
                ...
                {
                    if (CategoryDAO.Instance.UpdateCategory(name, id, active))
                    {
            ...
            {
                MessageBox.Show("Tình trạng danh mục phải là 0 hoặc 1");
            }
        }
        ...
        private void btnAddAccount_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Loại tài khoản phải là 0 hoặc 1");
            }
        ...
        private void buttDone_Click(object sender, EventArgs e)
        {
            try
            {
                TableDAO.Instance.GetTableWithName((lbTable.Tag as Table).Name);
            ...
            catch { MessageBox.Show("Không tìm thấy bàn để sửa"); }
        ...
        private void btnAddCode_Click(object sender, EventArgs e)
        {
            ...
            if (Rate == "")
            {
                MessageBox.Show("% giảm không hợp lệ");
            }
            else
            {
                try
                ...
                {
                    MessageBox.Show("Số lần phải là số nguyên");
                }      
            }
        }
